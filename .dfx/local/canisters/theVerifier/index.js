...
import { idlFactory } from './theVerifier.did.js';
export { idlFactory } from './theVerifier.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.THEVERIFIER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./theVerifier.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the theVerifier canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./theVerifier.did.js")._SERVICE>}
 */
export const theVerifier = createActor(canisterId);
