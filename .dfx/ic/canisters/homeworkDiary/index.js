...
import { idlFactory } from './homeworkDiary.did.js';
export { idlFactory } from './homeworkDiary.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HOMEWORKDIARY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./homeworkDiary.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the homeworkDiary canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./homeworkDiary.did.js")._SERVICE>}
 */
export const homeworkDiary = createActor(canisterId);
